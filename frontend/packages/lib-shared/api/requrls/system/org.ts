...
export const syncOrgOperationUrl = '/user/sync/operation'; // 用户(员工)-同步组织架构
export const syncScheduleConfigUrl = '/user/sync/schedule-config'; // 用户(员工)-同步组织架构定时任务配置
export const syncThirdOrgUrl = '/user/sync/third-org'; // 获取第三方的组织架构
