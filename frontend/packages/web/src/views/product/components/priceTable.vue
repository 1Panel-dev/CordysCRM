<template>
  <div ref="priceCardRef" class="h-full px-[16px] pt-[16px]">
    <CrmTable
      ref="crmTableRef"
      ...
      :draggable="!props.readonly && hasAnyPermission(['PRICE:UPDATE'])"
    ...
    >
      <template #actionLeft>
        <div class="flex items-center gap-[12px]">
          <n-button v-if="hasAnyPermission(['PRICE:ADD']) && !props.readonly" type="primary" @click="handleCreate">
            {{ t('product.newPrice') }}
          </n-button>
          <CrmImportButton
            v-if="hasAnyPermission(['PRICE:IMPORT']) && !props.readonly"
...
<script setup lang="ts">
  ...
  import PriceDetailDrawer from './priceDetailDrawer.vue';
