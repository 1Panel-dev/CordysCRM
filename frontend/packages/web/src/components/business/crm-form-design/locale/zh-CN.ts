export default {
  ...
  'crmFormDesign.detailTabs': '详情页标签',
  'crmFormDesign.detailTabsSetting': '详情页标签设置',
  'crmFormDesign.detailTabsConfigured': '已设置',
  'crmFormDesign.detailTabName': '标签名称',
  'crmFormDesign.relatedForm': '关联表单',
  'crmFormDesign.relatedField': '关联字段',
  'crmFormDesign.detailTabsClearTip': '确定清空自定义详情页标签吗？',
  'crmFormDesign.detailTabsClearTipContent': '清空后，系统默认标签将保留。',
  'crmFormDesign.detailTabNameRequired': '请输入标签名称',
  'crmFormDesign.detailTabNameDuplicate': '标签名称重复，请重新输入',
  'crmFormDesign.detailTabRelationDuplicate': '关联表单和关联字段不能重复',
  'crmFormDesign.detailTabIncomplete': '请完善详情页标签配置',
  'crmFormDesign.detailTabRelatedFormInvalid': '关联表单已失效，请重新选择',
  'crmFormDesign.detailTabRelatedFieldInvalid': '关联字段已失效，请重新选择',
  'crmFormDesign.detailTabRelatedFieldLoading': '关联字段加载中，请稍后保存',
  ...
  'crmFormDesign.statistics': '统计',
  'crmFormDesign.statisticsTargetForm': '目标统计表单',
  'crmFormDesign.statisticsType': '统计类型',
  'crmFormDesign.statisticsSUM': '总和',
  'crmFormDesign.statisticsCOUNT': '计数',
  'crmFormDesign.statisticsAVG': '平均值',
  'crmFormDesign.statisticsField': '统计字段',
  'crmFormDesign.statisticsRange': '统计范围',
  'crmFormDesign.statisticsRangeConditions': '符合以下条件',
  'crmFormDesign.statisticsFieldEmpty': '字段为空时',
  'crmFormDesign.notCalculation': '不参与计算',
  'crmFormDesign.statisticsOnEmpty': '结果为空时',
  'crmFormDesign.statisticsDefaultEmpty': '默认为空(显示-)',
  'crmFormDesign.statisticsDefaultZero': '默认为0',
  'crmFormDesign.statisticsUpdateRange': '更新范围',
  'crmFormDesign.existingDataNotCalculation': '现有数据不计算',
  'crmFormDesign.allCalculation': '全部计算',
  'crmFormDesign.allCalculationTip': '(数量大，计算时间长)',
  'crmFormDesign.calculationByRange': '符合以下数据范围计算',
  'crmFormDesign.requiredFieldAttrNotEmpty': '必填属性不能为空',
};
