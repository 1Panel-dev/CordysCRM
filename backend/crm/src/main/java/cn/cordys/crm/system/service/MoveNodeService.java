...
public abstract class MoveNodeService {
   ...
   * @return
   */
  public NodeSortDTO getNodeSortDTO(
      NodeMoveRequest request,
      Function<String, BaseTree> selectIdNodeFunc,
      Function<NodeSortQueryParam, BaseTree> selectPosNodeFunc,
    ...
    if (request.getDropPosition() == 0) {
      parentModule =
          new BaseTree(
              ...
              dropNode.getName(),
              dropNode.getPos(),
              dropNode.getOrganizationId(),
              dropNode.getParentId());
