...
public class WorkerNode implements Serializable {
  ...
  @NotBlank(
      message = "{worker_node.id.not_blank}",
      groups = {Updated.class})
  private Long id;

  @Schema(description = "host name", requiredMode = Schema.RequiredMode.REQUIRED)
  @NotBlank(
      message = "{worker_node.host_name.not_blank}",
      groups = {Created.class})
  @Size(
      min = 1,
      max = 64,
      message = "{worker_node.host_name.length_range}",
      groups = {Created.class, Updated.class})
  private String hostName;

  @Schema(description = "port", requiredMode = Schema.RequiredMode.REQUIRED)
  @NotBlank(
      message = "{worker_node.port.not_blank}",
      groups = {Created.class})
  @Size(
      min = 1,
      max = 64,
      message = "{worker_node.port.length_range}",
      groups = {Created.class, Updated.class})
  private String port;
