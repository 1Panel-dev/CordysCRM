...
public class UserExcelData {
  /** 工号 */
  @ExcelIgnore private String employeeId;

  /** 姓名 */
  @ExcelIgnore private String name;

  /** 性别 */
  @ExcelIgnore private String gender;

  /** 部门 */
  @ExcelIgnore private String department;

  /** 职位 */
  @ExcelIgnore private String position;

  /** 手机号 */
  @ExcelIgnore private String phone;

  /** 邮箱 */
  @ExcelIgnore private String email;

  /** 直属上级 */
  @ExcelIgnore private String supervisor;

  /** 工作城市 */
  @ExcelIgnore private String workCity;

  /** 员工类型 */
  @ExcelIgnore private String employeeType;
