...
public class OrganizationUserController {
  ...
  @Resource private OrganizationConfigService organizationConfigService;
  ...
  public void addUser(@Validated @RequestBody UserAddRequest request) {
    organizationUserService.addUser(
  ...
  public void updateUser(@Validated @RequestBody UserUpdateRequest request) {
    organizationUserService.updateUser(
  ...
  public void resetPassword(@PathVariable String userId) {
    organizationUserService.resetPassword(
        userId, SessionUtils.getUserId(), OrganizationContext.getOrganizationId());
  }
  ...
  public void enable(@Validated @RequestBody UserBatchEnableRequest request) {
    organizationUserService.enable(
        request, SessionUtils.getUserId(), OrganizationContext.getOrganizationId());
  }
  ...
  public void batchResetPassword(@Validated @RequestBody UserBatchRequest request) {
    organizationUserService.batchResetPassword(
        request, SessionUtils.getUserId(), OrganizationContext.getOrganizationId());
  }
  ...
  public void batchEditUser(@Validated @RequestBody UserBatchEditRequest request) {
    organizationUserService.batchEditUser(
        request, SessionUtils.getUserId(), OrganizationContext.getOrganizationId());
  }
  ...
  public UserImportResponse preCheckXMind(
  ...
  @RequiresPermissions(PermissionConstants.SYS_ORGANIZATION_IMPORT)
  public UserImportResponse importUser(
      @RequestPart(value = "file", required = false) MultipartFile file) {
    return organizationUserService.importByExcel(
  ...
  public List<DeptUserTreeNode> getDepartmentUser(@PathVariable String departmentId) {
    return organizationUserService.getUserTreeByDepId(
        departmentId, OrganizationContext.getOrganizationId());
  }
}
