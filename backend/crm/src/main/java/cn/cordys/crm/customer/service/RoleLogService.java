...
public class RoleLogService extends BaseModuleLogService {
          ...
          if (Strings.CS.equals(differ.getColumn(), "deptIds")) {
            ...
            if (differ.getOldValue() != null) {
              differ.setOldValueName(
                  Translator.get(
                      "role.data_permission." + differ.getOldValue().toString().toLowerCase()));
            }
            if (differ.getNewValue() != null) {
              differ.setNewValueName(
                  Translator.get(
                      "role.data_permission." + differ.getNewValue().toString().toLowerCase()));
            }
  ...
  private Map<String, String> getDeptNameMap(Object oldValue, Object newValue) {
    ...
    return departmentService.getDepartmentOptionsByIds(deptIds).stream()
