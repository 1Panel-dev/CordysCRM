...
public class ProductLogService extends BaseModuleLogService {
  ...
  @Resource private BaseMapper<ModuleField> moduleFieldBaseMapper;
  @Resource private BaseMapper<ModuleForm> moduleFormBaseMapper;
  ...
  private ModuleContext buildModuleContext(String orgId) {
    ...
    Optional<ModuleForm> formOptional =
        moduleFormBaseMapper
            .selectListByLambda(
    ...
    List<ModuleField> fields =
        moduleFieldBaseMapper.selectListByLambda(
            new LambdaQueryWrapper<ModuleField>().eq(ModuleField::getFormId, formId));
  ...
  private record ModuleContext(
      String pictureFieldId, String timeFieldId, List<String> attachFieldIds) {
    static final ModuleContext EMPTY = new ModuleContext(null, null, Collections.emptyList());
  }
}
