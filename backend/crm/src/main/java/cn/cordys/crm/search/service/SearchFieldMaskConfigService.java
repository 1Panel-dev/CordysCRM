...
public class SearchFieldMaskConfigService {
  ...
  @Resource private BaseMapper<SearchFieldMaskConfig> searchFieldMaskConfigMapper;
   ...
   * @param moduleType
   */
  private void saveMaskFields(
      List<String> fieldIds, String userId, String orgId, String formKey, String moduleType) {
    if (CollectionUtils.isNotEmpty(fieldIds)) {
      ...
      for (String fieldId : fieldIds) {
        ...
        if (baseField.getType().equals("DATA_SOURCE_MULTIPLE")) {
          fieldMaskConfig.setDataSourceType(
  ...
  public FieldMaskConfigDTO get(String orgId) {
    ...
    List<SearchFieldMaskConfig> searchFieldMaskConfigs =
        searchFieldMaskConfigMapper.selectListByLambda(queryWrapper);
        ...
        searchFieldMaskConfigs.stream()
            .collect(
                Collectors.groupingBy(
                    ...
                    Collectors.mapping(SearchFieldMaskConfig::getFieldId, Collectors.toList())));
