...
public class SseController {
  ...
  public Flux<?> subscribe(
      @RequestParam String userId, @RequestParam String clientId, HttpServletResponse response) {
  ...
  public String broadcast(
      @RequestParam String userId, @RequestParam String clientId, @RequestParam String message) {
