...
public class LoginLogController {
  ...
  public Pager<List<LoginLogListResponse>> loginList(
      @Validated @RequestBody LoginLogRequest request) {
    Page<Object> page = PageHelper.startPage(request.getCurrent(), request.getPageSize());
    return PageUtils.setPageInfo(
        page, sysLoginLogService.list(request, OrganizationContext.getOrganizationId()));
  }
}
