...
public class CustomerRelationController {
  ...
  public CustomerRelation add(
      @PathVariable String customerId,
      @Validated @RequestBody CustomerRelationSaveRequest request) {
  ...
  public CustomerRelation update(
      @PathVariable String customerId,
      @Validated @RequestBody CustomerRelationUpdateRequest request) {
  ...
  public void save(
      @PathVariable String customerId,
      @Validated @RequestBody @Valid @NotNull List<CustomerRelationSaveRequest> requests) {
