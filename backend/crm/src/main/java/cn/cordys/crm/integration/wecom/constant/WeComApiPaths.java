...
public interface WeComApiPaths {
  ...
  /**
   * 获取Access token 接口文档: <a
   * href="https://developer.work.weixin.qq.com/document/path/91039">https://developer.work.weixin.qq.com/document/path/91039</a>
   *
   * <pre>
  ...
  /**
   * 获取指定的应用详情 接口文档: <a
   * href="https://developer.work.weixin.qq.com/document/path/96448">https://developer.work.weixin.qq.com/document/path/91039</a>
   *
   * <pre>
   ...
   *
   * <p>接口文档: <a
   * href="https://developer.work.weixin.qq.com/document/path/90208">https://developer.work.weixin.qq.com/document/path/90208</a>
   * <br>
   * http请求方式: GET
   ...
   * 通讯录同步”的新增IP将不能再调用此接口，企业可通过「获取成员ID列表」和「获取部门ID列表」接口获取userid和部门ID列表。查看调整详情。<br>
   *
   * <p>接口文档: <a
   * href="https://developer.work.weixin.qq.com/document/path/90201">https://developer.work.weixin.qq.com/document/path/90201</a>
   * <br>
   * http请求方式: GET
   ...
   *
   * <p>接口文档: <a
   * href="https://developer.work.weixin.qq.com/document/path/91023">https://developer.work.weixin.qq.com/document/path/91023</a>
   * http请求地址: GET
   ...
   *
   * <p>接口文档： <a href="https://developer.work.weixin.qq.com/document/path/95833">...</a>
   * 请求方式：POST（HTTPS） http请求地址: POST
   * https://qyapi.weixin.qq.com/cgi-bin/auth/getuserdetail?access_token=ACCESS_TOKEN 请求包体：
   *
   * <p>{ "user_ticket": "USER_TICKET" }
   */
   ...
   *
   * <p>从2022年6月20号20点开始，除通讯录同步以外的基础应用（如客户联系、微信客服、会话存档、日程等），以及新创建的自建应用与代开发应用，调用该接口时，不再返回以下字段：头像、性别、手机、邮箱、企业邮箱、员工个人二维码、地址，应用需要通过oauth2手工授权的方式获取管理员与员工本人授权的字段。
   *
   * <p>接口文档： <a href="https://developer.work.weixin.qq.com/document/path/96255">...</a>
   * 请求方式：POST（HTTPS） http请求地址: GET
   ...
   * 接口文档: <a
   * href="https://developer.work.weixin.qq.com/document/path/90236#%E6%96%87%E6%9C%AC%E6%B6%88%E6%81%AF">https://developer.work.weixin.qq.com/document/path/91039</a>
   * 请求方式: POST（HTTPS） http请求地址: POST <a
   * href="https://qyapi.weixin.qq.com/cgi-bin/message/send?access_token=ACCESS_TOKEN">...</a>
   */
