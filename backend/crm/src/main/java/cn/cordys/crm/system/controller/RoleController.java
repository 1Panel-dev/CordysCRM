...
public class RoleController {
  ...
  @RequiresPermissions(PermissionConstants.SYSTEM_ROLE_READ)
  public Pager<List<RoleUserListResponse>> listUser(
      @Validated @RequestBody RoleUserPageRequest request) {
    Page<Object> page = PageHelper.startPage(request.getCurrent(), request.getPageSize());
    return PageUtils.setPageInfo(
        page, userRoleService.listUserByRoleId(request, OrganizationContext.getOrganizationId()));
  }
  ...
  public void deleteRoleUser(@PathVariable String id) {
    userRoleService.deleteRoleUser(
  ...
  public void batchDeleteRoleUser(@RequestBody List<String> ids) {
    userRoleService.batchDeleteRoleUser(
