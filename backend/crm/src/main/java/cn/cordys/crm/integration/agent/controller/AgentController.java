...
public class AgentController {
  ...
  @Resource private AgentBaseService agentBaseService;
  ...
  public Agent addAgent(@Validated @RequestBody AgentAddRequest request) {
    return agentBaseService.addAgent(
  ...
  public Pager<List<AgentPageResponse>> list(@Validated @RequestBody AgentPageRequest request) {
    return agentBaseService.getList(
        request, SessionUtils.getUserId(), OrganizationContext.getOrganizationId());
  }
  ...
  public List<AgentOptionDTO> getAgentList() {
    return agentBaseService.getAgentOptions(
  ...
  public ThirdConfigBaseDTO<?> getApplicationConfig() {
    return integrationConfigService.getApplicationConfig(
