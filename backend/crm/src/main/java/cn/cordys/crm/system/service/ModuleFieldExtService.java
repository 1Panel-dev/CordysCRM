...
public class ModuleFieldExtService {
  ...
  @Resource private BaseMapper<ModuleForm> formMapper;
  @Resource private BaseMapper<ModuleField> fieldMapper;
  @Resource private BaseMapper<ModuleFieldBlob> fieldBlobMapper;
  ...
  public List<String> getFieldIdsOfForm(String formKey, String orgId) {
    ...
    return allFields.stream().filter(BaseField::isAttachment).map(BaseField::getId).toList();
  }
   ...
   * @return 字段规则集合
   */
  public List<String> getSerialFieldRulesByKey(
      String formKey, String currentOrg, String internalKey) {
