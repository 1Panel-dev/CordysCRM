...
public class ContractController {
  ...
  @Resource private ContractExportService contractExportService;
  ...
  public ContractGetResponse getSnapshot(@PathVariable("id") String id) {
    return contractService.getSnapshotWithDataPermissionCheck(
  ...
  public PagerWithOption<List<ContractListResponse>> list(
      @Validated @RequestBody ContractPageRequest request) {
  ...
  public void approval(@Validated @RequestBody ContractApprovalRequest request) {
    contractService.approvalContract(
        request, SessionUtils.getUserId(), OrganizationContext.getOrganizationId());
  }
  ...
  public BatchAffectSkipResponse batchApproval(
      @Validated @RequestBody ContractApprovalBatchRequest request) {
    return contractService.batchApprovalContract(
        request, SessionUtils.getUserId(), OrganizationContext.getOrganizationId());
  }
  ...
  public PagerWithOption<List<ContractPaymentPlanListResponse>> paymentPlanList(
      @Validated @RequestBody ContractDetailPaymentPlanPageRequest request) {
    ConditionFilterUtils.parseCondition(request);
  ...
  public PagerWithOption<List<ContractPaymentRecordResponse>> paymentRecordList(
  ...
  public ResourceTabEnableDTO getTabEnableConfig() {
    return contractService.getTabEnableConfig(
  ...
  public PagerWithOption<List<ContractInvoiceListResponse>> invoiceList(
      @Validated @RequestBody ContractDetailInvoicePageRequest request) {
    ConditionFilterUtils.parseCondition(request);
    request.setViewId(InternalUserView.ALL.name());
    DeptDataPermissionDTO deptDataPermission =
        dataScopeService.getDeptDataPermission(
  ...
  public CustomerInvoiceStatisticResponse calculateCustomerInvoiceStatistic(
    ...
    BigDecimal invoiceAmount =
        contractInvoiceService.calculateContractInvoiceAmount(
            contractId, SessionUtils.getUserId(), OrganizationContext.getOrganizationId());
