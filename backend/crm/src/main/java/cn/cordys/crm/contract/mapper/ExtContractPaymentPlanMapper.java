...
public interface ExtContractPaymentPlanMapper {
  List<ContractPaymentPlanListResponse> list(
      @Param("request") ContractPaymentPlanPageRequest request,
      @Param("userId") String userId,
      @Param("orgId") String orgId,
      @Param("dataPermission") DeptDataPermissionDTO deptDataPermission);

  List<ContractPaymentPlanListResponse> getListByIds(
      @Param("ids") List<String> ids,
      @Param("userId") String userId,
      @Param("orgId") String orgId,
      @Param("dataPermission") DeptDataPermissionDTO deptDataPermission);

  CustomerPaymentPlanStatisticResponse calculateCustomerPaymentPlanStatistic(
      @Param("customerId") String customerId,
      @Param("userId") String userId,
      @Param("orgId") String orgId,
      @Param("dataPermission") DeptDataPermissionDTO deptDataPermission);

  List<ContractPaymentPlan> selectByTimestamp(
