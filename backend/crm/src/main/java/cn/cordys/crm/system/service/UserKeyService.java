...
public class UserKeyService {
  ...
  @Resource private BaseMapper<UserKey> userKeyMapper;
  ...
  private void logApiKeyAction(UserKey userKey) {
    ...
    OperationLogContext.setContext(LogContextInfo.builder().modifiedValue(userKey).build());
