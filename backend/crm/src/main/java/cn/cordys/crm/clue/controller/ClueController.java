...
public class ClueController {
  ...
  @Resource private ClueExportService clueExportService;
  ...
  public ClueGetResponse get(@PathVariable String id) {
    return clueService.getWithDataPermissionCheck(
  ...
  public void transitionCustomer(@Validated @RequestBody ClueTransitionCustomerRequest request) {
    clueService.transitionCustomer(
        request, SessionUtils.getUserId(), OrganizationContext.getOrganizationId());
  }
  ...
  public BatchAffectResponse batchToPool(@RequestBody BatchPoolReasonRequest request) {
    return clueService.batchToPool(
        request, SessionUtils.getUserId(), OrganizationContext.getOrganizationId());
  }
  ...
  public ResourceTabEnableDTO getTabEnableConfig() {
    return clueService.getTabEnableConfig(
  ...
  public String exportAll(@Validated @RequestBody ClueExportRequest request) {
    ...
    DeptDataPermissionDTO deptDataPermission =
        dataScopeService.getDeptDataPermission(
            ...
            request.getViewId(),
            PermissionConstants.CLUE_MANAGEMENT_READ);
    return clueExportService.exportAll(
        request,
        SessionUtils.getUserId(),
        OrganizationContext.getOrganizationId(),
        deptDataPermission,
  ...
  public String exportSelect(@Validated @RequestBody ExportSelectRequest request) {
    return clueExportService.exportSelect(
        request,
        SessionUtils.getUserId(),
        OrganizationContext.getOrganizationId(),
        LocaleContextHolder.getLocale());
  ...
  public PagerWithOption<List<CustomerListResponse>> transitionCustomerPage(
      @Validated @RequestBody CustomerPageRequest request) {
    ConditionFilterUtils.parseCondition(request);
    return customerService.transitionList(
        request, SessionUtils.getUserId(), OrganizationContext.getOrganizationId());
  }
