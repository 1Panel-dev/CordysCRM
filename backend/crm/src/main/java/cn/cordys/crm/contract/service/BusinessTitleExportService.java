...
public class BusinessTitleExportService extends BaseExportService {
  ...
  public List<List<Object>> getSelectExportData(
    ...
    // 获取数据
    List<BusinessTitleListResponse> allList =
        extBusinessTitleMapper.getListByIds(ids, userId, orgId);
  ...
  private List<Object> buildData(List<ExportHeadDTO> headList, BusinessTitleListResponse data) {
    ...
    return transModuleFieldValue(
        headList, systemFiledMap, new HashMap<>(), dataList, new HashMap<>());
  }
  ...
  public List<List<Object>> getExportData(String taskId, ExportDTO exportDTO)
    ...
    // 获取数据
    List<BusinessTitleListResponse> dataList =
        extBusinessTitleMapper.list(pageRequest, orgId, exportDTO.getUserId());
