...
public class NotificationController {
  ...
  public Pager<List<NotificationDTO>> listNotification(
      @Validated @RequestBody NotificationRequest notificationRequest) {
    Page<Object> page =
        PageHelper.startPage(
            notificationRequest.getCurrent(), notificationRequest.getPageSize(), true);
  ...
  public List<NotificationDTO> listLastNotification() {
    return notificationService.listLastNotification(
  ...
  public List<NotificationDTO> listLastAnnouncement() {
    return notificationService.listLastAnnouncement(
        SessionUtils.getUserId(), OrganizationContext.getOrganizationId());
  }
  ...
  public List<OptionCountDTO> countNotification(
    ...
    return notificationService.countNotification(
        notificationRequest, OrganizationContext.getOrganizationId(), SessionUtils.getUserId());
  }
}
