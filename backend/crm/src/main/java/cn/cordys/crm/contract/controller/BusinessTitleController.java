...
public class BusinessTitleController {
  ...
  @Resource private BusinessTitleExportService businessTitleExportService;
  ...
  public BusinessTitle add(@Validated @RequestBody BusinessTitleAddRequest request) {
    return businessTitleService.add(
  ...
  public BusinessTitle update(@Validated @RequestBody BusinessTitleUpdateRequest request) {
    return businessTitleService.update(
        request, SessionUtils.getUserId(), OrganizationContext.getOrganizationId());
  }
  ...
  public Pager<List<BusinessTitleListResponse>> list(
      @Validated @RequestBody BusinessTitlePageRequest request) {
  ...
  public void approval(@Validated @RequestBody BusinessTitleApprovalRequest request) {
    businessTitleService.approvalContract(
        request, SessionUtils.getUserId(), OrganizationContext.getOrganizationId());
  }
  ...
  public String revoke(@PathVariable("id") String id) {
    return businessTitleService.revoke(
  ...
  @RequiresPermissions(PermissionConstants.CONTRACT_BUSINESS_TITLE_IMPORT)
  public ImportResponse preCheck(
  ...
  @RequiresPermissions(PermissionConstants.CONTRACT_BUSINESS_TITLE_IMPORT)
  public ImportResponse realImport(
      @RequestPart(value = "file", required = false) MultipartFile file) {
    return businessTitleService.realImport(
        file, SessionUtils.getUserId(), OrganizationContext.getOrganizationId());
  }
  ...
  public Pager<List<String>> thirdQueryOptions(@Validated @RequestBody BasePageRequest request) {
    return businessTitleService.thirdQueryOption(
        request.getKeyword(), request.getCurrent(), OrganizationContext.getOrganizationId());
  }
