...
public interface ExtDashboardMapper {
  ...
  int countByName(
      ...
      @Param("dashboardModuleId") String dashboardModuleId,
  ...
  List<DashboardTreeNode> selectDashboardNode(
      @Param("departmentIds") List<String> departmentIds,
      @Param("orgId") String orgId,
      @Param("userId") String userId);

  List<DashboardPageResponse> list(
      @Param("request") DashboardPageRequest request,
      @Param("userId") String userId,
      @Param("orgId") String orgId,
      @Param("departmentIds") List<String> departmentIds);
