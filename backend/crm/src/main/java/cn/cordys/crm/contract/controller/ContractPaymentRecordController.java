...
public class ContractPaymentRecordController {
  ...
  @Resource private ContractPaymentRecordExportService contractPaymentRecordExportService;
  ...
  public ModuleFormConfigDTO getModuleFormConfig() {
    return moduleFormCacheService.getBusinessFormConfig(
        FormKey.CONTRACT_PAYMENT_RECORD.getKey(), OrganizationContext.getOrganizationId());
  }
  ...
  @RequiresPermissions(
      value = {
        PermissionConstants.CONTRACT_PAYMENT_RECORD_ADD,
        PermissionConstants.CONTRACT_PAYMENT
      },
      logical = Logical.OR)
  @Operation(summary = "添加回款记录")
  public ContractPaymentRecord add(
      @Validated @RequestBody ContractPaymentRecordAddRequest request) {
    return contractPaymentRecordService.add(
  ...
  public ContractPaymentRecord update(
      @Validated @RequestBody ContractPaymentRecordUpdateRequest request) {
    return contractPaymentRecordService.update(
        request, SessionUtils.getUserId(), OrganizationContext.getOrganizationId());
  }
  ...
  public ContractPaymentRecordGetResponse get(@PathVariable String id) {
    return contractPaymentRecordService.getWithDataPermissionCheck(
  ...
  public ResourceTabEnableDTO getTabEnableConfig() {
    return contractPaymentRecordService.getTabEnableConfig(
  ...
  public void downloadImportTpl(HttpServletResponse response) {
    contractPaymentRecordService.downloadImportTpl(
        response, OrganizationContext.getOrganizationId());
  }
  ...
  public ImportResponse preCheck(@RequestPart(value = "file") MultipartFile file) {
    return contractPaymentRecordService.importPreCheck(
        file, OrganizationContext.getOrganizationId());
  }
  ...
  public ImportResponse realImport(@RequestPart(value = "file") MultipartFile file) {
    return contractPaymentRecordService.realImport(
