...
public class DashboardController {
  ...
  public Dashboard addDashboard(@Validated @RequestBody DashboardAddRequest request) {
    return dashboardService.addDashboard(
  ...
  public Pager<List<DashboardPageResponse>> list(
      @Validated @RequestBody DashboardPageRequest request) {
