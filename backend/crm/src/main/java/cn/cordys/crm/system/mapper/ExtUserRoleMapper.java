...
public interface ExtUserRoleMapper {
  ...
  List<RoleUserListResponse> list(
      @Param("request") RoleUserPageRequest request, @Param("orgId") String orgId);

  List<DeptUserTreeNode> selectUserDeptForRelevance(
      @Param("orgId") String orgId, @Param("roleId") String roleId);

  List<DeptUserTreeNode> selectUserDeptForOrg(@Param("orgId") String orgId);

  List<RoleUserTreeNode> selectUserRoleForRelevance(
      @Param("orgId") String orgId, @Param("roleId") String roleId);
  ...
  List<RoleUserOptionResponse> selectUserOptionByRoleId(
      @Param("orgId") String orgId, @Param("roleId") String roleId);
