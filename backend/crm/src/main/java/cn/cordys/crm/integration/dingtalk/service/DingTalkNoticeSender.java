  ...
  private void sendDingTalk(String context, NoticeModel noticeModel, String organizationId) {
    ...
    OrganizationConfigDetail orgConfigDetailByIdAndType =
        extOrganizationConfigDetailMapper.getOrgConfigDetailByIdAndType(
            organizationConfig.getId(), ThirdDetailType.DINGTALK_SYNC.name());
    ...
    tokenService.sendDingNoticeByToken(
        dingTalkSendDTO,
        dingTalkThirdConfigRequest.getAgentId(),
        dingTalkThirdConfigRequest.getAppSecret());
  }
}
