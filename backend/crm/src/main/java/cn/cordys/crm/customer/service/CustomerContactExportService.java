...
public class CustomerContactExportService extends BaseExportService {
  ...
  public String export(
      String userId,
      CustomerContactExportRequest request,
      String orgId,
  ...
  private List<List<Object>> getExportData(
    ...
    // 获取数据
    List<CustomerContactListResponse> allList =
        extCustomerContactMapper.list(request, userId, orgId, deptDataPermission, false);
  ...
  private List<Object> buildData(
    ...
    LinkedHashMap<String, Object> systemFiledMap =
        CustomerContactFieldUtils.getSystemFieldMap(data);
    // 自定义字段map
  ...
  public String exportSelect(
      String userId, ExportSelectRequest request, String orgId, Locale locale) {
    checkFileName(request.getFileName());
    // 用户导出数量限制
    exportTaskService.checkUserTaskLimit(userId, ExportConstants.ExportStatus.PREPARED.toString());
  ...
  private List<List<Object>> getExportDataBySelect(
      ...
      throws InterruptedException {
    var allList =
        Optional.ofNullable(extCustomerContactMapper.getListByIds(ids))
