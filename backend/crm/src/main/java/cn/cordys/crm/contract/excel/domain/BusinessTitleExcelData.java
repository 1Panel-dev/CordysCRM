...
public class BusinessTitleExcelData {
  /** 公司名称 */
  @ExcelIgnore private String name;

  /** 纳税人识别号 */
  @ExcelIgnore private String identificationNumber;

  /** 开户银行 */
  @ExcelIgnore private String openingBank;

  /** 银行账户 */
  @ExcelIgnore private String bankAccount;

  /** 注册地址 */
  @ExcelIgnore private String registrationAddress;

  /** 注册电话 */
  @ExcelIgnore private String phoneNumber;

  /** 注册资本 */
  @ExcelIgnore private String registeredCapital;

  /** 公司规模 */
  @ExcelIgnore private String companySize;

  /** 工商注册账号 */
  @ExcelIgnore private String registrationNumber;
