...
public class AnnouncementRequest {
  ...
  @Size(
      min = 1,
      max = 255,
      message = "{announcement.subject.length_range}",
      groups = {Created.class, Updated.class})
  @NotBlank(
      message = "{announcement.subject.not_blank}",
      groups = {Created.class, Updated.class})
  @Schema(description = "公告标题", requiredMode = Schema.RequiredMode.REQUIRED)
  private String subject;

  @NotBlank(
      message = "{announcement.content.not_blank}",
      groups = {Created.class, Updated.class})
  @Schema(description = "公告内容", requiredMode = Schema.RequiredMode.REQUIRED)
  private String content;

  @NotBlank(
      message = "{announcement.startTime.not_blank}",
      groups = {Created.class, Updated.class})
  @Schema(description = "开始时间", requiredMode = Schema.RequiredMode.REQUIRED)
  private Long startTime;

  @NotBlank(
      message = "{announcement.endTime.not_blank}",
      groups = {Created.class, Updated.class})
