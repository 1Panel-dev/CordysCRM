...
public class OperationLogController {
  ...
  public Pager<List<OperationLogResponse>> list(
      @Validated @RequestBody OperationLogRequest request) {
    Page<Object> page = PageHelper.startPage(request.getCurrent(), request.getPageSize());
    return PageUtils.setPageInfo(
        page, sysOperationLogService.list(request, OrganizationContext.getOrganizationId()));
  }
