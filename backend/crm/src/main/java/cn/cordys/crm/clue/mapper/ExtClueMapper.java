...
public interface ExtClueMapper {
  ...
  List<ClueListResponse> list(
      @Param("request") CluePageRequest request,
   ...
   * @return 相似线索列表
   */
  List<AdvancedClueResponse> getSimilarClueList(
      @Param("customerName") String customerName, @Param("orgId") String orgId);
   ...
   * @return 重复线索列表
   */
  List<AdvancedClueResponse> getRepeatClueList(
      @Param("customerName") String customerName, @Param("orgId") String orgId);
  ...
  List<GlobalClueResponse> globalSearchList(
      @Param("request") BasePageRequest request, @Param("orgId") String orgId);

  long globalSearchListCount(
      @Param("request") BasePageRequest request, @Param("orgId") String orgId);

  List<GlobalCluePoolResponse> globalPoolSearchList(
      @Param("request") BasePageRequest request, @Param("orgId") String orgId);

  long globalPoolSearchListCount(
      @Param("request") BasePageRequest request, @Param("orgId") String orgId);

  List<Clue> searchColumnsByIds(
      @Param("columns") List<String> columns, @Param("ids") List<String> ids);
  ...
  List<ChartResult> chart(
      @Param("request") ClueChartAnalysisDbRequest request,
      @Param("userId") String userId,
      @Param("orgId") String orgId,
