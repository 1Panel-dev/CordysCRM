...
public class OpportunityController {
  ...
  @Resource private OpportunityExportService opportunityExportService;
  ...
  public OpportunitySearchStatisticResponse searchStatistic(
      @Validated @RequestBody OpportunitySearchStatisticRequest request) {
    ConditionFilterUtils.parseCondition(request);
    DeptDataPermissionDTO deptDataPermission =
        dataScopeService.getDeptDataPermission(
            SessionUtils.getUserId(),
            ...
            request.getViewId(),
            PermissionConstants.OPPORTUNITY_MANAGEMENT_READ);
    return opportunityService.searchStatistic(
        request,
        SessionUtils.getUserId(),
        OrganizationContext.getOrganizationId(),
        deptDataPermission);
  ...
  public void delete(@RequestBody @NotEmpty List<String> ids) {
    opportunityService.batchDelete(
  ...
  @RequiresPermissions(
      value = {
        ...
        PermissionConstants.OPPORTUNITY_MANAGEMENT_RESIGN
      },
      logical = Logical.OR)
  ...
  public void batchUpdate(@Validated @RequestBody ResourceBatchEditRequest request) {
    opportunityService.batchUpdate(
        request, SessionUtils.getUserId(), OrganizationContext.getOrganizationId());
  }
  ...
  public ResourceTabEnableDTO getTabEnableConfig() {
    return opportunityService.getTabEnableConfig(
  ...
  public CustomerContactListAllResponse list(@Validated @PathVariable String opportunityId) {
    return opportunityService.getContactList(
        opportunityId, OrganizationContext.getOrganizationId());
  }
  ...
  public String opportunityExportAll(@Validated @RequestBody OpportunityExportRequest request) {
    ...
    DeptDataPermissionDTO deptDataPermission =
        dataScopeService.getDeptDataPermission(
            ...
            request.getViewId(),
            PermissionConstants.OPPORTUNITY_MANAGEMENT_READ);
    return opportunityExportService.export(
        SessionUtils.getUserId(),
        request,
        OrganizationContext.getOrganizationId(),
        deptDataPermission,
  ...
  public String opportunityExportSelect(@Validated @RequestBody ExportSelectRequest request) {
    return opportunityExportService.exportSelect(
        SessionUtils.getUserId(),
        request,
        OrganizationContext.getOrganizationId(),
        LocaleContextHolder.getLocale());
  ...
  public ImportResponse realImport(@RequestPart(value = "file") MultipartFile file) {
    return opportunityService.realImport(
  ...
  public List<ChartResult> chart(@Validated @RequestBody ChartAnalysisRequest request) {
    DeptDataPermissionDTO deptDataPermission =
        dataScopeService.getDeptDataPermission(
            ...
            request.getViewId(),
            PermissionConstants.OPPORTUNITY_MANAGEMENT_READ);
    return opportunityService.chart(
        request,
        SessionUtils.getUserId(),
        OrganizationContext.getOrganizationId(),
        deptDataPermission);
