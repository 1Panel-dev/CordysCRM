...
public enum BusinessModuleField {
    ...
    CONTRACT_PRODUCT("contractProduct", "product", Set.of("dataSourceType"), FormKey.CONTRACT.getKey()),
    CONTRACT_PRODUCT_AMOUNT("contractProductAmount", "price", null, FormKey.CONTRACT.getKey()),
