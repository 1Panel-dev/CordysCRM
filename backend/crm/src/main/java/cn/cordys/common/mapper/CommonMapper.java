...
public interface CommonMapper {
     ...
     * @return
     */
    BaseResourceSubField getResourceField(@Param("tableName") String tableName, @Param("resourceId") String resourceId, @Param("fieldId") String fieldId, @Param("subRowId") Integer subRowId, @Param("refSubId") String refSubId);
