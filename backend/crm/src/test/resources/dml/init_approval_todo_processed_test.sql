...
VALUES
    ('todo_processed_task_001', 'node_done', 1,'todo_processed_inst_001', 'admin', 'APPROVED', 'approve', 'APPROVED', 1736241043609, 1736241043609, 'admin', 'admin'),
    ('todo_pending_task_001', 'node_wait', 1,'todo_pending_inst_001', 'admin', 'PENDING', 'approve', 'PENDING', 1736242043609, 1736242043609, 'admin', 'admin');
